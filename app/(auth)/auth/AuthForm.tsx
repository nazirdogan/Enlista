        ...
        >
          <div style={{ width: '100%', maxWidth: 400 }}>
            ...
            <div style={{ marginBottom: 32 }}>
              <h2 style={{
                fontSize: 26, fontWeight: 800, color: '#0F1829',
            ...
            <form onSubmit={handleSignUp} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
              ...
              <button
                ...
                style={{
                  width: '100%',
                  background: loading || !allSignUpFilled ? '#1D4ED8' : '#1D4ED8',
                  color: 'white',
                  padding: '14px',
                  borderRadius: 8,
                  border: 'none',
            ...
            {/* Footer */}
            <p style={{ marginTop: 22, textAlign: 'center', fontSize: 13, color: '#64748B', marginBottom: 0 }}>
