...
const TRANSCRIBED_TEXT = 'This stunning three-bedroom villa in Arabian Ranches offers luxury living at its finest...';
...
export const Reel1VoiceToCopy = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(Audio, { src: reel1Audio }), _jsxs(InstagramFrame, { backgroundColor: BRAND_COLORS.WHITE, children: [frame < OPEN_FRAMES.end && (_jsxs("div", { style: { opacity: openingOpacity, textAlign: 'center', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }, children: [_jsxs("div", { style: {
                                    position: 'relative',
                                    width: 120,
                                    height: 120,
                                    marginBottom: 40,
                                        ...
                                        }, children: _jsxs("svg", { width: 60, height: 60, viewBox: "0 0 24 24", fill: "white", children: [_jsx("path", { d: "M12 14c1.66 0 3-1.34 3-3V5c0-1.66-1.34-3-3-3S9 3.34 9 5v6c0 1.66 1.34 3 3 3z" }), _jsx("path", { d: "M17 16.91c-1.48 1.45-3.47 2.33-5.7 2.33-2.24 0-4.23-.88-5.7-2.33M19 12h2c0 2.96-1.48 5.6-3.74 7.21l1.41 1.41C21.5 19.54 23 16.54 23 13v-1h-2v-2z" })] }) })] }), _jsx("div", { style: {
                                    fontSize: TYPOGRAPHY.SIZES.XXL,
                                    fontWeight: TYPOGRAPHY.WEIGHTS.BOLD,
                                    color: BRAND_COLORS.BLACK,
                                    fontFamily: TYPOGRAPHY.FAMILY,
                                    textAlign: 'center',
                                }, children: "Say it once." })] })), frame < VOICE_FRAMES.end && frame >= VOICE_FRAMES.start && (_jsxs("div", { style: {
                            ...
                            textAlign: 'center',
                                    ...
                                    fontFamily: TYPOGRAPHY.FAMILY,
                                    marginBottom: 32,
                                }, children: "\uD83C\uDFA4 Listening..." }), _jsx(TextReveal, { text: TRANSCRIBED_TEXT, startFrame: VOICE_FRAMES.start, endFrame: VOICE_FRAMES.end - 60, fontSize: TYPOGRAPHY.SIZES.LG, fontWeight: TYPOGRAPHY.WEIGHTS.REGULAR, color: BRAND_COLORS.BLACK, fontFamily: TYPOGRAPHY.FAMILY })] })), frame >= GENERATION_FRAMES.start && frame < GENERATION_FRAMES.end && (_jsxs("div", { style: {
                            flex: 1,
                            display: 'flex',
                            flexDirection: 'column',
                            justifyContent: 'center',
                            ...
                            paddingLeft: 24,
                            paddingRight: 24,
                        }, children: [_jsx(CardSlideIn, { startFrame: GENERATION_FRAMES.start, endFrame: GENERATION_FRAMES.start + 90, direction: "left", distance: 200, children: _jsxs("div", { style: {
                                        ...
                                        position: 'relative',
                                                ...
                                                marginBottom: 12,
                                                paddingRight: 40,
                                            }, children: ENGLISH_PROPERTY.title }), _jsx("div", { style: {
                                                fontSize: TYPOGRAPHY.SIZES.BASE,
                                                fontWeight: TYPOGRAPHY.WEIGHTS.REGULAR,
                                                color: BRAND_COLORS.MUTED,
                                                fontFamily: TYPOGRAPHY.FAMILY,
                                                marginBottom: 12,
                                            }, children: ENGLISH_PROPERTY.description }), _jsx("div", { style: { position: 'absolute', top: 20, right: 20 }, children: _jsx(IconCheckmark, { startFrame: GENERATION_FRAMES.start + 90, endFrame: GENERATION_FRAMES.start + 120, size: 24, color: BRAND_COLORS.BLUE }) })] }) }), _jsx(CardSlideIn, { startFrame: GENERATION_FRAMES.start + 120, endFrame: GENERATION_FRAMES.start + 210, direction: "right", distance: 200, children: _jsxs("div", { style: {
                                        ...
                                        position: 'relative',
                                                ...
                                                textAlign: 'right',
                                                direction: 'rtl',
                                            }, children: ARABIC_PROPERTY.title }), _jsx("div", { style: {
                                                fontSize: TYPOGRAPHY.SIZES.BASE,
                                                fontWeight: TYPOGRAPHY.WEIGHTS.REGULAR,
                                                color: BRAND_COLORS.MUTED,
                                                fontFamily: TYPOGRAPHY.FAMILY,
                                                ...
                                                textAlign: 'right',
                                                direction: 'rtl',
                                            }, children: ARABIC_PROPERTY.description }), _jsx("div", { style: { position: 'absolute', top: 20, right: 20 }, children: _jsx(IconCheckmark, { startFrame: GENERATION_FRAMES.start + 210, endFrame: GENERATION_FRAMES.start + 240, size: 24, color: BRAND_COLORS.GREEN }) })] }) })] })), frame >= MULTI_CHANNEL_FRAMES.start && frame < MULTI_CHANNEL_FRAMES.end && (_jsxs("div", { style: {
                            ...
                            paddingRight: 24,
                                    ...
                                    fontFamily: TYPOGRAPHY.FAMILY,
                                    marginBottom: 20,
                                }, children: "Ready for:" }), _jsx("div", { style: {
                                    display: 'grid',
                                    ...
                                    return (_jsxs("div", { style: {
                                            ...
                                            border: `2px solid ${platform.color}`,
                                                    ...
                                                    color: BRAND_COLORS.BLACK,
                                                    fontFamily: TYPOGRAPHY.FAMILY,
                                                }, children: platform.name }), _jsx(IconCheckmark, { startFrame: platformEndFrame - 10, endFrame: platformEndFrame + 10, size: 20, color: platform.color })] }, platform.name));
                                }) })] })), frame >= CTA_FRAMES.start && frame < CTA_FRAMES.end && (_jsx("div", { style: {
                            opacity: ctaOpacity,
                            flex: 1,
                            display: 'flex',
                            justifyContent: 'center',
                            ...
                            paddingBottom: 60,
                                ...
                                fontFamily: TYPOGRAPHY.FAMILY,
                                textAlign: 'center',
                            }, children: "Try free at enlista.ai" }) }))] })] }));
};
//# sourceMappingURL=Reel1_VoiceToCopy.js.map